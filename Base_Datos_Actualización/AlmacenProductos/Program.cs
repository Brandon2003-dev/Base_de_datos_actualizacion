...
while (comprobar)
{
    ...
    Console.WriteLine("----------------------------------------");
    Console.WriteLine("      1. Agregar los Producto           ");
    Console.WriteLine("      2. Actualizar los Productos       ");
    Console.WriteLine("      3. Eliminar los Productos         ");
    Console.WriteLine("      4. Listado de los  Productos      ");
    ...
    switch (Menu)
    {
        case 1:
            ...
            while (bucle == 1)
            {
                ...
                Console.WriteLine("- Descripcion de el producto:");
